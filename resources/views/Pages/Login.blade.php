                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <div class="text-center mb-3">
                                        <a href="index. html"><img src="https://panel.mondopedia.it/logos/app_logo.png"
                                                alt=""></a>
                                    </div>
                                    <h4 class="text-center mb-4">Sign up your account</h4>
                                    <form action="https://yashadmin.dexignzone.com/xhtml/index.html">
                                        <div class="mb-3">
                                        ...
                                        <div class="form-row d-flex flex-wrap justify-content-between mb-2">
                                            ...
                                            <div class="form-group ms-2">
                                                <a class="text-hover" href="page-forgot-password.html">Forgot
                                                    Password?</a>
                                            </div>
                                        </div>
